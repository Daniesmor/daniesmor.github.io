...
ninja.data = [{
    ...
    section: "Navigation",
    handler: () => {
      window.location.href = "/~daniesmor/";
    },
  },{id: "nav-blog",
          title: "blog",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/~daniesmor/blog/";
          },
        },{id: "nav-publications",
          title: "publications",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/~daniesmor/publications/";
          },
        },{id: "nav-projects",
          title: "projects",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/~daniesmor/projects/";
          },
        },{id: "nav-cv",
          title: "cv",
          description: "",
          section: "Navigation",
          handler: () => {
            window.location.href = "/~daniesmor/cv/";
          },
        },{
        id: 'socials-email',
        title: 'Send email',
